...
Public Class XPad
    ...
    Friend Sub NewWindow(ByVal Text As String, ByVal Title As String)
        ...
        XPad_SubForm.Text = Me.Text = "Xtreme Browser User: " + Current_User + ", XPad " + " - " + Navigator.SelectedTab.Text
        XPad.Name = "XPad"
        XPad.Dock = DockStyle.Fill
    ...
    Friend Sub CloseTab()
        ...
        Catch ex As Exception
            MessageBox.Show(ex.Message, "XPad", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
    ...
    Private Sub Navigator_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Navigator.SelectedIndexChanged
        Me.Text = ("Xtreme Browser User: " + Current_User + ", XPad " + " - " + Navigator.SelectedTab.Text)
    End Sub
End Class